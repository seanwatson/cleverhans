...
from cleverhans.utils_keras import cifar_10_cnn_model
...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
    ...
    model = cifar_10_cnn_model(img_rows=28, img_cols=28, channels=1)
    preds = model(x)
    ...
    model_2 = cifar_10_cnn_model(img_rows=28, img_cols=28, channels=1)
    preds_2 = model_2(x)
